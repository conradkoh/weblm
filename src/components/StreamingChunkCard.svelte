<script lang="ts">
  ...
  let { content, index, status, streamingText = '' }: Props = $props();
...
>
  ...
  <div class="px-3 py-2 bg-gray-50 dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 flex items-center gap-2">
